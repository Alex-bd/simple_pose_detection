...
if MODE is "COCO":
    protoFile = r"D:/CODE/python/simple_pose_detection/coco/pose_deploy_linevec.prototxt"
    weightsFile = r"D:/CODE/python/simple_pose_detection/coco/pose_iter_440000.caffemodel"
    nPoints = 18
    POSE_PAIRS = [[1, 0], [1, 2], [1, 5], [2, 3], [3, 4], [5, 6], [6, 7], [1, 8], [8, 9], [9, 10], [1, 11],
                  [11, 12], [12, 13], [0, 14], [0, 15], [14, 16], [15, 17]]

elif MODE is "MPI":
    protoFile = r"D:/CODE/python/simple_pose_detection/mpi/pose_deploy_linevec.prototxt"
    weightsFile = r"D:/CODE/python/simple_pose_detection/mpi/pose_iter_160000.caffemodel"
    nPoints = 15
    POSE_PAIRS = [[0, 1], [1, 2], [2, 3], [3, 4], [1, 5], [5, 6], [6, 7], [1, 14], [14, 8], [8, 9], [9, 10],
                  [14, 11], [11, 12], [12, 13]]

# 输入图像路径
userImageInput = r"D:/CODE/python/simple_pose_detection/Image_Pose/inputImage/6.jpg"
print(userImageInput)

# 背景
img = r"D:/CODE/python/simple_pose_detection/White.jpg"

frame = cv2.imread(userImageInput)  # 读入图像
print(frame.shape)
frameWhite = cv2.imread(img)    # 读入写出图像
...
for i in range(nPoints):  # 遍历18个关节点
    # 相应身体部位的置信度图。
    probMap = output[0, i, :, :]
    # print(probMap)
...
athletesOutputFirst = r"D:/CODE/python/simple_pose_detection/Image_Pose/outputImage/output_1.jpg"
athletesOutputSecond = r"D:/CODE/python/simple_pose_detection/Image_Pose/outputImage/output_2.jpg"
