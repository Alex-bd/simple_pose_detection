...
if MODE is "COCO":
    protoFile = "D:/CODE/python/simple_pose_detection/coco/pose_deploy_linevec.prototxt"
    weightsFile = "D:/CODE/python/simple_pose_detection/coco/pose_iter_440000.caffemodel"
    nPoints = 18
...
userImageInput = cv2.VideoCapture(r"D:/CODE/python/simple_pose_detection/Video_Pose/inputVideo/input_1.mp4")
...
out = cv2.VideoWriter(r'D:/CODE/python/simple_pose_detection/Video_Pose/outputVideo/1.mp4', fourcc, 30, (frameWidth1, frameHeight1))
out1 = cv2.VideoWriter(r'D:/CODE/python/simple_pose_detection/Video_Pose/outputVideo/2.mp4', fourcc, fps, (frame_width, frame_height))
threshold = 0.1
